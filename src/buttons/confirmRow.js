...
const cancelButton = new ButtonBuilder().setCustomId('N').setLabel('N').setStyle(ButtonStyle.Danger);
const confirmButton = new ButtonBuilder().setCustomId('Y').setLabel('Y').setStyle(ButtonStyle.Secondary);
